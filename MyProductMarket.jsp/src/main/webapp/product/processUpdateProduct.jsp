...
<body>
	<%
	System.out.println("processUpdateProduct.jsp 도착!!");
	...
	System.out.println("procuessUpdatePro에서의 productId: "+productId);
	...
	pdao.updateProduct(productId, name, price, description, category, manufacturer,stock,condition,fileName);
